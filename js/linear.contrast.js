var LinearContrast = {
    ...
    new: function() {
        ...
        bcp.append("circle")
            ...
            .attr("cy", this.y1)
            .attr("r", 10)
            .attr("onmouseenter", "IIPhistogram.contrast_display(LinearContrast.blackValue, LinearContrast.blackIntensity)")
        ...
        wcp.append("circle")
            ...
            .attr("cy", this.y2)
            .attr("r", 10)
            .attr("onmouseenter", "IIPhistogram.contrast_display(LinearContrast.whiteValue, LinearContrast.whiteIntensity)")
            .attr("onmouseleave", "IIPhistogram.reset_contrast_display()");
