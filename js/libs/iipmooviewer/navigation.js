...
var Navigation = new Class({
  ...
  initialize: function( options ){
    ...
    this.options.loadBarWidth = $("div#viewer").width() / 3;
  },
  ...
  create: function( container ){
    this.size.x = $("div#panner", parent.document.body).width();
    this.size.y = $("div#panner", parent.document.body).height();
	...
	'class': 'navwin',
      ...
      navwin.inject( $("div#panner div.navcontainer", parent.document)[0]  );
	...
	//container: this.navcontainer.getElement('div.navwin'),
        container: $("div#panner div.navcontainer div.navwin", parent.document.body)[0],
  ...
  refreshLoadBar: function( nTilesLoaded, nTilesToLoad ) {
    ...
    var w = (nTilesLoaded / nTilesToLoad) * this.options.loadBarWidth;

    //var loadBarContainer = this.navcontainer.getElement('div.loadBarContainer');
    var loadBarContainer = document.id("viewer").getElement('div.loadBarContainer');
  ...
  setImage: function( src ){
        $("div#panner div.navcontainer div.navwin img.navimage", parent.document)[0].src = src;
//        $("div#panner div.navcontainer div.navwin img.navimage", parent.document)[0].width = this.size.x;
//        $("div#panner div.navcontainer div.navwin img.navimage", parent.document)[0].height = this.size.y;
